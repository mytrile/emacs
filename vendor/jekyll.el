...
;;
(global-set-key (kbd "C-c j d") 'jekyll-draft-post)
(global-set-key (kbd "C-c j p") 'jekyll-publish-post)
(global-set-key (kbd "C-c j r") 'jekyll-deploy)
...
(defvar jekyll-directory "/home/mitkok/dev/repo/blog/"
  "Path to Jekyll blog.")
